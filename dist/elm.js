...
var _user$project$Decoder$Data = function (a) {
	return {data: a};
};
var _user$project$Decoder$Result = function (a) {
	return {meaningList: a};
};
var _user$project$Decoder$Meaning = function (a) {
	return {text: a};
};
var _user$project$Decoder$meaningDecoder = A4(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
	'text',
	_elm_lang$core$Json_Decode$string,
	'',
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Decoder$Meaning));
var _user$project$Decoder$resultDecoder = A4(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
	'meanings',
	_elm_lang$core$Json_Decode$list(_user$project$Decoder$meaningDecoder),
	{ctor: '[]'},
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Decoder$Result));
var _user$project$Decoder$dataDecoder = A4(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
	'tuc',
	_elm_lang$core$Json_Decode$list(_user$project$Decoder$resultDecoder),
	{ctor: '[]'},
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Decoder$Data));
...
var _user$project$Jsonp$randomCallbackName = function () {
...
var _user$project$Jsonp$jsonp = _user$project$Native_Jsonp.jsonp;
var _user$project$Jsonp$get = F2(
	function (decoder, url) {
		...
		return A2(
			...
			A2(
				_elm_lang$core$Task$andThen,
				_user$project$Jsonp$jsonp(url),
				_user$project$Jsonp$randomCallbackName));
	});
...
var _user$project$Main$footerView = A2(
	...
	{
		ctor: '::',
		_0: _elm_lang$html$Html$text('បង្កើតដោយ'),
		_1: {
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('blue no-underline'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$href('https://github.com/chmar77/elm-khmer-dictionary'),
						_1: {
							ctor: '::',
		...
		A2(
			...
			function (meaning) {
				return A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('lh-kh'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							A2(
								...
								'- ',
								_marcosh$elm_html_to_unicode$ElmEscapeHtml$unescape(
									_marcosh$elm_html_to_unicode$ElmEscapeHtml$unescape(meaning.text)))),
						_1: {ctor: '[]'}
					});
			},
			result.meaningList));
};
var _user$project$Main$loadingView = function (searchText) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('mb3 green'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text(
				A2(
					_elm_lang$core$Basics_ops['++'],
					'កំពុងស្វែងរកពាក្យ \"',
					A2(_elm_lang$core$Basics_ops['++'], searchText, '\" ...'))),
			_1: {ctor: '[]'}
		});
};
var _user$project$Main$lookupInfo = function (phrase) {
	return A2(
		_user$project$Jsonp$get,
		_user$project$Decoder$dataDecoder,
		A2(_elm_lang$core$Basics_ops['++'], 'https://glosbe.com/gapi_v0_1/translate?from=km&dest=ljp&format=json&phrase=', phrase));
};
...
var _user$project$Main$Model = F6(
	function (a, b, c, d, e, f) {
		return {title: a, searchText: b, errorText: c, loading: d, result: e, resultList: f};
	});
var _user$project$Main$NoOp = {ctor: 'NoOp'};
var _user$project$Main$OnInputFocus = function (a) {
	return {ctor: 'OnInputFocus', _0: a};
};
var _user$project$Main$OnFetchData = function (a) {
	return {ctor: 'OnFetchData', _0: a};
};
var _user$project$Main$fetchData = function (phrase) {
	return A2(
		_elm_lang$core$Task$attempt,
		_user$project$Main$OnFetchData,
		_user$project$Main$lookupInfo(phrase));
};
		...
		switch (_p0.ctor) {
			...
			case 'ClearText':
				return {
					...
					_1: A2(
						_elm_lang$core$Task$attempt,
						_user$project$Main$OnInputFocus,
						_elm_lang$dom$Dom$focus('input'))
				};
			case 'Search':
				var _p1 = model.searchText;
				if (_p1 === '') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{errorText: 'សូមសរសេរពាក្យ'}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{loading: true, result: false, errorText: ''}),
						_1: _user$project$Main$fetchData(model.searchText)
					};
				}
			case 'OnInputFocus':
				var _p2 = _p0._0;
				if (_p2.ctor === 'Ok') {
					...
					var _p3 = A2(_elm_lang$core$Debug$log, 'Focus Dom', _p2._0);
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			case 'OnFetchData':
				var _p4 = _p0._0;
				if (_p4.ctor === 'Ok') {
					var _p6 = _p4._0;
					var _p5 = A2(_elm_lang$core$Debug$log, 'Fetch Data', _p6);
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{resultList: _p6.data, result: true, loading: false}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					var _p7 = A2(_elm_lang$core$Debug$log, 'Fetch Data', _p4._0);
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
			default:
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
...
var _user$project$Main$ClearText = {ctor: 'ClearText'};
...
var _user$project$Main$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('w-100 w-60-ns center dark-gray pa2 '),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('f2 mb3 mt2 mid-gray title-kh tc'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('mb3 dib ba bw2 br2 b--light-gray pa2 flex'),
						_1: {
							ctor: '::',
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('bn noselect outline-0 lh-kh flex-auto'),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$placeholder('ពាក្យ'),
									_1: {
										ctor: '::',
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('pv2 ph3 bn bg-white pointer hover-bg-light-gray mr1'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$type_('button'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$ClearText),
											_1: {ctor: '[]'}
										}
									}
								},
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('pa2 bg-light-gray bn br1 pointer hover-bg-moon-gray'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('ស្វែងរក'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('my-mh'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: (!_elm_lang$core$Native_Utils.eq(model.errorText, '')) ? A2(
								_elm_lang$html$Html$p,
								{
									ctor: '::',
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(model.errorText),
									_1: {ctor: '[]'}
								}) : A2(
								_elm_lang$html$Html$div,
								{ctor: '[]'},
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$core$Native_Utils.eq(model.loading, true) ? _user$project$Main$loadingView(model.searchText) : A2(
									_elm_lang$html$Html$div,
									{ctor: '[]'},
									{ctor: '[]'}),
								_1: {
									ctor: '::',
									_0: _elm_lang$core$Native_Utils.eq(model.result, true) ? (_elm_lang$core$Native_Utils.eq(
										model.resultList,
										{ctor: '[]'}) ? A2(
										_elm_lang$html$Html$p,
										{
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('ស្វែងរកមិនមាន'),
											_1: {ctor: '[]'}
										}) : A2(
										_elm_lang$html$Html$div,
										{ctor: '[]'},
										A2(_elm_lang$core$List$map, _user$project$Main$resultView, model.resultList))) : A2(
										_elm_lang$html$Html$div,
										{ctor: '[]'},
										{ctor: '[]'}),
									_1: {ctor: '[]'}
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Dom.Error":{"args":[],"tags":{"NotFound":["String"]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Main.Msg":{"args":[],"tags":{"ClearText":[],"OnFetchData":["Result.Result Http.Error Decoder.Data"],"OnInputFocus":["Result.Result Dom.Error ()"],"SearchInput":["String"],"Search":[],"NoOp":[]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}},"aliases":{"Decoder.Meaning":{"args":[],"type":"{ text : String }"},"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Decoder.Data":{"args":[],"type":"{ data : List Decoder.Result }"},"Decoder.Result":{"args":[],"type":"{ meaningList : List Decoder.Meaning }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
